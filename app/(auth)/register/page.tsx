...
export default function Register() {
    return (
        <TestPageDesign
            ...
            subject="Please enter your details to create an account"
            body="This is a practice registration page for the Next.js project. You can customize this page with your own design and functionality."
        >
            <div className="mt-5">
